...
copy_required_driver "$NUGET_ROOT/selenium.webdriver.chromedriver/$CHROME_DRIVER_VERSION/driver/linux64/chromedriver" "$PUBLISH_DIR"
copy_required_driver "$NUGET_ROOT/selenium.webdriver.msedgedriver/$EDGE_DRIVER_VERSION/driver/linux64/msedgedriver" "$PUBLISH_DIR"
